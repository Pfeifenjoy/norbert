...
\begin{tabularx}{\textwidth}{|l|l|X|l|}
    ...
    F-Types-10 & Erinnerung & Ein Eintrag der zu einem Zeitpunkt in einem News-Feed angezeigt wird. & 2 \\
...
Hier ist zu sehen, dass ein Eintrag modular aufgebaut ist. Standardmäßig muss für einen Eintrag ein Titel vergeben werden.
...
\begin{tabularx}{\textwidth}{|l|X|l|l|}
    ...
    F-00.3 & Die Software kann auf Desktopgeräten und mobilen Geräten verwendet werden. & 1 & \\
    F-00.4 & Es wird ein Server zum Austausch der Daten zwischen den Clients verwendet. & 1 & \\
    F-00.5 & Eine Website dient als Schnittstelle zwischen dem Anwender und den Daten und dient als User Interface. & 1 & F-00.4\\
    ...
    F-10.7 & Es können externe Dienste wie z.B. ein Kursverteiler als Datenquelle durch einen Administrator festgelegt werden. & 1 & F-10.6\\
    F-10.8 & Es können Benutzer angelegt werden. & 1 &\\
    F-10.9 & Ein Benutzer kann über einen Namen oder eine E-Mail Adresse identifiziert werden. & 1 &\\
    \hline
    ...
    F-30.3 & Der Benutzer kann Einträge aus seinem Newsfeed entfernen und hinzufügen. & 1 & \\
    F-30.4 & Es werden auch Einträge von anderen Benutzern angezeigt. & 1 & \\
    F-30.5 & Einträge von anderen Benutzern werden auf Basis der eigenen Einträge gefiltert. Diese Funktion ist nicht immer eindeutig, weshalb auch interessante Einträge gefiltert werden können. & 1 & F-30.4\\
    ...
    F-50.A.3 & Externe Dienste werden nach Links (Url) durchsucht. Daraus wird ein Eintrag generiert der dem Benutzer diese als nützlichen Link vorschlägt. & 1 & \\
    ...
    F-50.A.5 & Externe Dienste werden nach Benutzernamen / E-Mail Adressen durchsucht, wodurch gezielte Eintragsvorschläge für einen Benutzer generiert werden. & 2 & F-10.9 \\
    ...
    F-60.2 & Ein Benutzer kann gefragt werden ob aus den von Norbert analysierten Daten ein Eintrag angelegt werden soll. Dabei hat der Benutzer die Wahl ob der Eintrag hinzugefügt werden soll. & 2 & \\
...
%    \hline
    ...
    F-50.2 & Es können Benutzer durch die Eingabe von E-Mail Adressen hinterlegt werden. & & \\
    F-50.2.1 & Die so erstellten Benutzer erhalten über eine E-Mail Zugriff auf das System. & & \\ % TODO: Formulierung
